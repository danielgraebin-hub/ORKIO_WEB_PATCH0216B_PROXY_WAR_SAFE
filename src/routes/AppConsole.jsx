...
// Basic telemetry + optional live captions
  ...
  function downloadRealtimeAta() {
    try {
      ...
      const tenant = (getTenant() || 'public').trim() || 'public';
      const base = (typeof window !== "undefined" && window.__ORKIO_ENV__?.VITE_API_BASE_URL) ? window.__ORKIO_ENV__.VITE_API_BASE_URL.replace(/\/$/, '') : '';
      const url = `${base}/api/realtime/sessions/${encodeURIComponent(sid)}/ata.txt`;
